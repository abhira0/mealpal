// One-off backfill for drizzle/0039_household_calendar_token.sql.
...
// silently 404s.
// Run once, after applying 0039 to the target DB: npx tsx scripts/backfill-calendar-tokens.ts
